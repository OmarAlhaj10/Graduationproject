...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 space-y-6 rounded-lg p-5 bg-bckgroung_main shadow-[#dc3545] shadow-lg">
      <Card className="mb-6 px-2 bg-bckgroung_main">
        <CardHeader>
          <h1 className="text-2xl font-bold text-red-600">Blog Posts</h1>
        </CardHeader>
        <CardBody>
          <div className="flex flex-col gap-4">                     
            ...
            >
              <Tab key="all" title="All Posts" className='bg-red-600 rounded-lg text-white' />
