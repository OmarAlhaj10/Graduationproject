...
const CategoriesPage: React.FC<CategoriesPageProps> = ({ isAuthenticated }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      <Card className="bg-bckgroung_main shadow-lg shadow-red-600">
        <CardHeader className="flex justify-between items-center ">
          <h1 className="text-2xl font-bold text-red-600 ">Categories</h1>
          {isAuthenticated && (
            <Button
              className="bg-red-600 text-white hover:scale-105"
        ...
        <CardBody className="bg-bckgroung_main">
          {error && (
          ...
          >
            <TableHeader>
              <TableColumn className="bg-red-500 text-white">NAME</TableColumn>
              <TableColumn>POST COUNT</TableColumn>
              <TableColumn className="bg-red-500 text-white">ACTIONS</TableColumn>
            </TableHeader>
            <TableBody
              isLoading={loading}
